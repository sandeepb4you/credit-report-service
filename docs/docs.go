...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/plans": {
            "get": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Requires plan:manage",
                        "schema": {
                            "$ref": "#/definitions/credit-report-service_internal_apperr.ErrorBody"
                        }
                    }
        ...
        "/admin/plans/{code}": {
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Plan code, e.g. CREDIT_ANALYSIS",
                        "name": "code",
                        "in": "path",
                        "required": true
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.updatePlanReq"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Nothing to change, or a negative amount",
                        "schema": {
                            "$ref": "#/definitions/credit-report-service_internal_apperr.ErrorBody"
                        }
                    },
        ...
        "/admin/referrals": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "First day, inclusive (YYYY-MM-DD). Defaults to 30 days before ` + "`" + `to` + "`" + `.",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Last day, inclusive (YYYY-MM-DD). Defaults to today (UTC).",
                        "name": "to",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "integer",
                        "description": "Max referred accounts to return (default 50, max 200)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Referred accounts to skip (default 0)",
                        "name": "offset",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handler.ReferralReportResponse"
                        }
                    },
                    "400": {
                        "description": "Unparseable date, inverted range, or a range over a year",
                        "schema": {
                            "$ref": "#/definitions/credit-report-service_internal_apperr.ErrorBody"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.phoneOtpSendReq"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.phoneOtpVerifyReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/credit-analytics/request": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Response header X-Report-Reused: true means an existing recent report was returned instead of a new bureau pull",
                        "schema": {
                            "$ref": "#/definitions/credit-report-service_internal_service.ReportInsights"
                        }
                    },
        ...
        "/kyc/pan": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "PAN and full name as printed on the card",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "credit-report-service_internal_models.ReferredAccount": {
            "type": "object",
            "properties": {
                "accountId": {
                    "type": "integer",
                ...
                "profileCompleted": {
                    "description": "ProfileCompleted is the cheapest signal of whether a referral turned\ninto a real user or stopped at the OTP screen.",
                    "type": "boolean"
                },
                "referredAt": {
                    "type": "string"
                ...
                "referredByCode": {
                    "description": "ReferredByCode is the code as typed at signup, which for an older\naccount may be a REF-prefixed one the referrer no longer holds.",
                    "type": "string",
                    "example": "K7QM4XZ"
                },
                "referredByName": {
        ...
        "credit-report-service_internal_models.ReferredPage": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/credit-report-service_internal_models.ReferredAccount"
                    }
                },
                "total": {
                    "type": "integer",
        ...
        "credit-report-service_internal_models.ReferrerSummary": {
            "type": "object",
            "properties": {
                "accountId": {
                    "type": "integer",
        ...
        "internal_handler.ReferralReportResponse": {
            "type": "object",
            "properties": {
                "from": {
                    "description": "From and To are the inclusive first and last day of the window.",
                    "type": "string",
                    "example": "2026-07-31"
                },
                "referred": {
                    "description": "Referred is the page of individual signups, narrowed to one referrer\nwhen the caller asked for that.",
                    "allOf": [
                        {
                ...
                "referrers": {
                    "description": "Referrers is the leaderboard for the window, busiest first. Always the\nwhole window, so the drill-down never hides who else was recruiting.",
                    "type": "array",
                    "items": {
        ...
        "internal_handler.phoneOtpSendReq": {
            "type": "object",
            "properties": {
                "phone": {
                    "type": "string",
        ...
        "internal_handler.updatePlanReq": {
            "type": "object",
            "properties": {
                "active": {
                    "type": "boolean",
